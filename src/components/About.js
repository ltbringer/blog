...
const About = () => (
  <>
    ...
    <p>The concept of life and death leave me at a loss for expression. I find it particularly difficult to behave when someone passes away. Events like that sprouted some seeds in childhood that have reared their heads now when I am 27. Death felt fair at times. <span style={{"fontStyle": "italic"}}>The old wither today so the young could blossom tomorrow.</span> But there were times where it felt wasteful that years of experience, knowledge, memories, emotions ...a consciousness, that will be no more. The best one can do now is live within books. <span style={{"fontStyle": "italic"}}>Write a book and forever stay alive within a curious mind.</span> Then again, there is only so much you can write. Good material takes years of work. There seems to be no better way for a child other than to start from knowing nothing, even reading has to be learned.</p>
