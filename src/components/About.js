...
const About = () => (
  <>
    ...
    <p>I see programming as a means to talk to machines. It saddens me a little because it's relegated to the status of <span style={{"fontStyle": "italic"}}>just a job</span>, and <span style={{"fontStyle": "italic"}}>there is nothing special about it.</span> While all this can really be depressing to go on, luckily I find my inspiration in Biology. The leeway a Doctor get's are far stricter on top of which resides conscience. They don't get to "Oh I forgot about that open valve, I'll patch tomorrow." but more than that the discoveries about the body and the mind leave me in pure awe of nature. Is all life coincidence? a self replicating, self healing compound called DNA just happened to form froth on rocks? and from there we move on to complex features like senses, perception, control, motion, emotion, practice, immunity, intelligence and instincts.</p>
